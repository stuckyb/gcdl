...
class PRISM(GSDataSet):
    def __init__(self, store_path):
        ...
        self.description = ('The PRISM Climate Group gathers climate '
        'observations from a wide range of monitoring networks, applies '
        'sophisticated quality control measures, and develops spatial '
        'climate datasets to reveal short- and long-term climate patterns. '
        'The resulting datasets incorporate a variety of modeling '
        'techniques and are available at multiple spatial/temporal '
        'resolutions, covering the period from 1895 to the present.')

        # Provider information
        self.provider_name = 'PRISM Climate Group, Oregon State University'
        self.provider_url = 'https://prism.oregonstate.edu/'
